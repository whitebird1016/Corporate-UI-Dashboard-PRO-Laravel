                ...
                <div class="col-12">
                    <div class="card">
                        <div class="pb-0 card-header">
                            <div class="row">
                                <div class="col-6">
                                    <h5 class="">Tag Management</h5>
                                    <p class="mb-0 text-sm">
                                        Here you can manage tags.
                                    </p>
                                </div>
                                @can('create', App\Models\Item::class)
                                    <div class="col-6 text-end">
                                        <a href="{{ route('tag-management.create') }}" class="btn btn-dark btn-primary">
                                            <i class="fas fa-user-plus me-2"></i> Add Tag
                                        </a>
                                    </div>
                                @endcan
                            </div>
                                    ...
                                    @foreach ($tags as $tag)
                                        <tr>
                                            <td class="text-sm text-center font-weight-normal">
                                                <span
                                                    class="text-secondary font-weight-normal">{{ $tag->id }}</span>
                                            </td>
                                            <td class="text-sm text-center font-weight-normal">
                                                <span
                                                    class="text-secondary font-weight-normal">{{ $tag->name }}</span>
                                            </td>
                                            <td class="text-sm text-center  font-weight-normal">
                                                <span
                                            ...
                                            <td class="text-sm text-center font-weight-normal">
                                                <span
                                                    class="text-secondary font-weight-normal">{{ $tag->created_at }}</span>
                                            </td>
                                            <td class="text-sm text-center font-weight-normal">
                                                <div class="d-flex justify-content-center">
                                                    @can('manage-items', App\User::class)
                                                        @can('update', $tag)
                                                            <div class="p">
                                                                <a href="{{ route('tag-management.edit', $tag->id) }}"
                                                        ...
                                                        @can('delete', $tag)
                                                            <div class="p">
                                                                <form role="form" method="post"
                                                                    action="{{ route('tag-management.destroy', $tag->id) }}">
                                                                    @csrf
                                                                    @method('post')
                                                                    <button type="submit"
