                ...
                <div class="col-lg-9 col-12 ">
                    <div class="card " id="basic-info">
                        ...
                        <div class="pt-0 card-body">
                            <form role="form" method="POST" action="{{ route('category-management.create') }}">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control no-resize" id="exampleFormControlTextarea1" required placeholder="Enter description"
