<x-app-layout>
        ...
        <div class="container px-2 py-1 min-w-100">
            <nav aria-label="breadcrumb">
                <ol class="px-0 pt-1 pb-0 mb-1 bg-transparent breadcrumb me-sm-6 me-5">
                    ...
                    <li class="text-sm breadcrumb-item  breadcrumb-text  text-dark  active" aria-current="page">Wallet
                    </li>
                </ol>
                <h6 class="mb-0 font-weight-bold breadcrumb-text  text-dark ">Wallet</h6>
            </nav>
    ...
    <div class="container py-3 my-3">
        <div class="row mt-n7 mb-6">
            <div class="col-lg-3 col-sm-6">
                <div class="card blur border border-white rounded-2 mb-4 shadow-xs">
                ...
                <div class="card shadow-xs border mb-4">
                    <div class="table-responsive p-0">
                        <table class="table align-items-center mb-0">
                            <thead>
                                <tr>
                                    <th class="border-top-0 d-flex align-items-center py-3 px-4 text-sm">
                                    ...
                                    <th
                                        class="border-top-0 text-secondary text-xs font-weight-semibold opacity-7 ps-2">
                                        Status</th>
                                    <th
                                        class="border-top-0 text-secondary text-xs font-weight-semibold opacity-7 ps-2">
                                        Amount</th>
                                    ...
                                    <div class="col-8 my-auto">
                                        <div class="d-flex">
                                            ...
                                            <div class="ms-auto text-end d-flex flex-column">
                                                ...
                                                <span
                                                    class="badge ms-2 badge-sm border border-success text-success bg-success border-radius-sm mt-auto mb-2">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="card card-background card-background-after-none align-items-start mb-2">
                                    <div class="full-background"
                                        style="background-image: url('../../assets/img/img-6.jpg')"></div>
                            ...
                            <div class="col-lg-6">
                                <div class="card card-background card-background-after-none align-items-start mb-2">
                                    <div class="full-background"
                                        style="background-image: url('../../assets/img/img-7.jpg')"></div>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div
                                                    ...
                                                    <p class="text-white text-sm w-50 mb-0 font-weight-bold">Corporate
                                                        UI</p>
                    ...
                    <li
                        ...
                        <div class="d-flex align-items-start">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <span class="text-sm text-info">Includes 1 user, 10GB individual data and access to all
                                    features.</span>
                            </div>
                        </div>
                        <div class="d-flex align-items-center text-danger text-gradient">
                            <div class="form-check">
                                <input type="radio" id="radio3" name="radioDisabled" id="customRadioDisabled"
                                    class="form-check-input form-check-input-info" checked>
                            </div>
                        </div>
                    </li>
                    <li
                        ...
                        <div class="d-flex align-items-start">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <span class="text-sm">Includes up to 10 users, 20GB individual data and access to all
                                    features.</span>
                            </div>
                        </div>
                        <div class="d-flex align-items-center text-danger text-gradient">
                    ...
                    <li
                        ...
                        <div class="d-flex align-items-start">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <span class="text-sm">Includes up to 20 users, 40GB individual data and access to all
                                    features.</span>
                            </div>
                        </div>
                        <div class="d-flex align-items-center text-danger text-gradient">
