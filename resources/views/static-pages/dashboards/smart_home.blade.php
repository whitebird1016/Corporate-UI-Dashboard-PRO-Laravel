<x-app-layout>
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <div class="px-5 py-4 container-fluid">
            <div class="row">
                <div class="mt-4 col-xl-5 h-100 ms-auto mt-xl-0">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="p-3 card-body z-index-1">
                                    <div class="row">
                                        <div class="my-auto col-8">
                                            <p
                                                class="mb-0 text-sm text-white position-absolute top-15 text-capitalize font-weight-bold opacity-7">
                                                Wheather today</p>
                                            <h5 class="mb-0 text-white position-absolute bottom-15 font-weight-bolder">
                                                San Francisco - 34°C
                                            </h5>
                                        </div>
                    ...
                    <div class="mt-4 row">
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-body p-4 text-center">
                                    <h1 class="text-primary"><span id="status1" countto="21">21</span> <span
                        ...
                        <div class="mt-4 col-md-6 mt-md-0">
                            <div class="card">
                                <div class="card-body p-4 text-center">
                                    <h1 class="text-primary"> <span id="status2" countto="44">44</span> <span
                    ...
                    <div class="mt-4 row">
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-body p-4 text-center">
                                    <h1 class="text-primary"><span id="status3" countto="87">87</span> <span
                        ...
                        <div class="mt-4 col-md-6 mt-md-0">
                            <div class="card">
                                <div class="card-body p-4 text-center">
                                    <h1 class="text-primary"><span id="status4" countto="417">417</span> <span
                ...
                <div class="col-xl-7">
                    <div class="card">
                        <div class="p-3 pb-0 border-0 card-header d-flex">
                            <h6 class="my-auto">Cameras</h6>
                            <div class="nav-wrapper position-relative ms-auto">
                                <div class="btn-group nav-pills" role="tablist">
                                    <input class="btn-check active" type="radio" name="btnradio" id="btnradio1"
                                        autocomplete="off" data-bs-toggle="tab" href="#cam1" role="tab"
                                        aria-controls="cam1" aria-selected="true" checked>
                                    <label class="px-4 mb-0 btn btn-white" for="btnradio1">Lounge</label>
                                    <input class="btn-check" type="radio" name="btnradio" id="btnradio2"
                                        autocomplete="off" data-bs-toggle="tab" tabindex="-1" href="#cam2"
                                        role="tab" aria-controls="cam2" aria-selected="false">
                                    <label class="px-4 mb-0 btn btn-white" for="btnradio2">Office</label>
                                    <input class="btn-check" type="radio" name="btnradio" id="btnradio3"
                                        autocomplete="off" data-bs-toggle="tab" tabindex="-1" href="#cam3"
                                        role="tab" aria-controls="cam3" aria-selected="false">
                                    <label class="px-4 mb-0 btn btn-white" for="btnradio3">Attic</label>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="py-2">
                                                        <div class="px-2 py-0 d-flex">
                                                            <span
                                                                class="badge badge-md rounded-1 badge-opaque bg-primary me-3">
                                                            </span>
                                                ...
                                                <tr>
                                                    <td class="py-2">
                                                        <div class="px-2 py-0 d-flex">
                                                            <span
                                                                class="badge badge-md rounded-1 badge-opaque bg-secondary me-3">
                                                            </span>
                                                            <div class="d-flex flex-column justify-content-center">
                                                ...
                                                <tr>
                                                    <td class="py-2">
                                                        <div class="px-2 py-0 d-flex">
                                                            <span
                                                                class="badge badge-md rounded-1 badge-opaque bg-info me-3">
                                                            </span>
                                                            <div class="d-flex flex-column justify-content-center">
                                                ...
                                                <tr>
                                                    <td class="py-2">
                                                        <div class="px-2 py-0 d-flex">
                                                            <span
                                                                class="badge badge-md rounded-1 badge-opaque bg-success me-3">
                                                            </span>
                                                            <div class="d-flex flex-column justify-content-center">
                                                ...
                                                <tr>
                                                    <td class="py-2">
                                                        <div class="px-2 py-0 d-flex">
                                                            <span
                                                                class="badge badge-md rounded-1 badge-opaque bg-danger me-3">
                                                            </span>
                                                            <div class="d-flex flex-column justify-content-center">
                            ...
                            <div class="card h-100">
                                <div class="card-body text-center p-3">
                                    ...
                                    <h4 class="font-weight-bold mt-n7"><span class="text-dark"
                                            id="value">29</span><span class="text-dark">°C</span></h4>
            ...
            <div class="row">
                ...
                <div class="mt-4 col-lg-2 col-sm-6 mt-md-0">
                    <div class="card bg-gradient-primary h-100">
                        <div class="card-body">
                            ...
                            <svg width="45px" viewBox="0 0 41 31" version="1.1"
                                ...
                                <g id="Page-1" stroke="none" stroke-width="1" fill="none"
                                    ...
                                    <g id="wifi" transform="translate(3.000000, 3.000000)">
                                        ...
                                        <circle fill="#FFFFFF" cx="17.5039082" cy="22.7484921" r="4.9082855">
                                        </circle>
                                        <path
                ...
                <div class="mt-4 col-lg-2 col-sm-6 mt-lg-0">
                    <div class="card h-100">
                        <div class="card-body">
                            ...
                            <span class="text-xs">Inactive since: 27 minutes</span>
                        </div>
                    </div>
                </div>
                <div class="mt-4 col-lg-2 col-sm-6 mt-lg-0">
    ...
    new Chart(ctx1, {
        ...
        data: {
            ...
            datasets: [{
                ...
                pointRadius: 2,
                borderWidth: 2,
                backgroundColor: ['#774DD3', '#64748b', '#55a6f8', '#67c23a', '#ea4e3d'],
                data: [15, 20, 13, 32, 20],
                fill: false
            }],
        },
