<x-app-layout>
    ...
    <main class="main-content  mt-0">
        <div class="pt-5 m-3 page-header align-items-start min-vh-50 pb-11 border-radius-lg"
            style="background-image: url('../../../assets/img/bg-purple-2.jpg'); background-position-y: 20%;">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="mx-auto text-center col-lg-5">
                        <h1 class="mt-5 mb-2 text-white">Welcome!</h1>
                        <p class="mb-0 text-white text-lead">Use these awesome forms to login or create new account in
                        ...
                        <div class="card-body">
                            <form role="form">
                                ...
                                <div class="text-center">
                                    <button type="button" class="my-4 mb-2 btn btn-dark w-100">Sign up</button>
                                </div>
